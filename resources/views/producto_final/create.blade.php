...
@section('header')Registrar productos @endsection
                            ...
                            <form class="user"  action="{{ route('productos.store') }}" method="POST"
                                ...
                                <div class="form-group row">
                                    <!--div class="col-sm-6 mb-3 mb-sm-0"-->
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                            name="nombre" placeholder="Nombre" value="{{ old('nombre') }}" required>
                                    <!--/div-->
                                    <br>
                               ...
                               <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-user" id="exampleInputEmail"
                                            name="descripcion" placeholder="Descripcion">{{ old('descripcion') }}</textarea>
                                    </div>
                                <div class="form-group">
                                    <input type="tel" class="form-control form-control-user" id="exampleInputEmail"
                                        name="precio" placeholder="Precio" value="{{ old('precio') }}">
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="submit" class="btn btn-facebook btn-user btn-block" value="Guardar">
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
